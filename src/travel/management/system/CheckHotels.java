...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
        ...
        String[] text=new String[]{"JW Mariott Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Raddison Blue Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Trident Hotel","Riverview Hotel"};
        try{
            for(int i=0;i<=9;i++){
